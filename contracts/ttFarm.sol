...
interface IEarningsReferral {
    ...
    function drainBEP20Token(IBEP20 _token, uint256 _amount, address _to) external;
}
...
contract HoneyToken is BEP20 {
    ...
    /**
     * @notice Constructs the HoneyToken contract.
     */
    constructor() public BEP20("Honey token", "HONEY") {
...
contract ttFarm is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    struct UserInfo {
        ...
        //   1. The pool's `accEarningsPerShare` (and `lastRewardBlock`) gets updated.
    ...
    address public earningToken = 0x486Ddf63175644d1172A02aec68B9B9AC3727386;
    ...
    // Update the given pool's Earnings allocation point. Can only be called by the owner.
    function set(
        uint256 _pid,
        uint256 _allocPoint,
        bool _withUpdate,
    ...
    // View function to see pending Earnings on frontend.
    ...
    // Safe Earnings transfer function, just in case if rounding error causes pool to not have enough
