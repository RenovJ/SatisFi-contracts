...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
    ...
    address public adminAddress = 0x8cA23deA974781c94D961950230FB1Ffdb61bB60;
...
contract ThunderEth is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public toBurnThunderAdaAddress = 0x0A7bB2bddA1c0eA02d98a7b048f4bF809F40277b;
    uint256 public toBurnThunderAdaFee = 2;

    address public teamWallet;
    address public marketingWallet;

    uint256 public maxBuyTransactionAmount = 5000000000 * 10 ** 18;
    uint256 public maxSellTransactionAmount = 50000000 * 10 ** 18;
    uint256 public swapTokensAtAmount = 50000000 * 10 ** 18;
    uint256 public maxWalletToken = 100000000000 * 10 ** 18;
    ...
    uint256 public gasForProcessing = 1300000;
    ...
    constructor() ERC20("ThunderETH.app", "THUNDERETH") {
        a80DividendTracker = new A80DividendTracker();
        b20DividendTracker = new B20DividendTracker();

        marketingWallet = 0x6708792796a0beE9493584BB26d207972Debb9BF;
        teamWallet = 0x27B81CF8A4cE177e7f9B0850984E06954D0090C2;
        a80DividendToken = 0x2170Ed0880ac9A755fd29B2688956BD959F933F8;
        b20DividendToken = 0x580dE58c1BD593A43DaDcF0A739d504621817c05;
    ...
    function updateBurnThunderCakeAddress(address _newAddress) external onlyOwner {
        toBurnThunderAdaAddress = _newAddress;
    }
    ...
    function setToBurnThunderAdaFee(uint256 newFee) external onlyOwner {
        require(newFee <= MAX_FEE_RATE, "wrong");
        toBurnThunderAdaFee = newFee;
        _updateTotalFee();
    }
    ...
    function _updateTotalFee() internal {
        totalFees = buyBackAndLiquidityFee.add(marketingFee).add(a80DividendRewardsFee).add(b20DividendRewardsFee).add(toBurnThunderAdaFee);
    }
    ...
    function updateA80DividendTracker(address newAddress) external onlyOwner {
        ...
        require(newA80DividendTracker.owner() == address(this), "must be owned by ThunderEth");
    ...
    function updateB20DividendTracker(address newAddress) external onlyOwner {
        ...
        require(newB20DividendTracker.owner() == address(this), "must be owned by ThunderEth");
    ...
    function _transfer(
        ...
        if (
            ...
            if (!swapping && contractTokenBalance >= swapTokensAtAmount) {
                ...
                if(marketingEnabled && buyBackAndLiquifyEnabled && toBurnThunderAdaFee > 0 && buyBackMode){

                    uint256 total3Fees = marketingFee.add(buyBackAndLiquidityFee).add(toBurnThunderAdaFee);
                    ...
                    if(increaseAmount > 0){
                        ...
                        uint256 bnbToBurnThunderBnb = increaseAmount.mul(toBurnThunderAdaFee).div(total3Fees);
                        useBnbToBurnThunderBnb(bnbToBurnThunderBnb);
                    }
                }else{
                    if (marketingEnabled) {
                    ...
                    if(toBurnThunderAdaFee > 0){
                        uint256 swapTokensToBurnThunderBnb = contractTokenBalance.mul(toBurnThunderAdaFee).div(totalFees);
                        buyBackThunderBnbAndBurn(swapTokensToBurnThunderBnb);
                    }
                }
    ...
    function useBnbToBurnThunderBnb(uint256 amount) private {
        // generate the uniswap pair path of token -> weth
        address[] memory path = new address[](2);
        path[0] = uniswapV2Router.WETH();
        path[1] = toBurnThunderAdaAddress;
    ...
    function buyBackThunderBnbAndBurn(uint256 amount) private {
        address[] memory path = new address[](3);
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();
        path[2] = toBurnThunderAdaAddress;
...
contract A80DividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("ETH80_Dividend_Tracker", "ETH80_Dividend_Tracker", 0x2170Ed0880ac9A755fd29B2688956BD959F933F8) {
        claimWait = 3600;
...
contract B20DividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("ETH20_Dividend_Tracker", "ETH20_Dividend_Tracker", 0x580dE58c1BD593A43DaDcF0A739d504621817c05) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 10000+ tokens
    }
