...
interface Buybackstrat{
    ...
    function defaultFeeBPS() external view returns(uint);
}
 ...
 */
contract PcsBnbStrat is Ownable, Pausable {
    ...
    address constant public eleven = address(0xAcD7B3D9c10e97d0efA418903C0c7669E702E4C0);
     ...
     */
    address constant public rewards  = address(0x3Ed531BfB3FAD41111f6dab567b33C4db897f991);//old contract
    address constant public treasury = address(0x6B3C201575aCe5Ed6B67df5c91E40B98c0D2BE36);
     ...
     */
    uint constant public REWARDS_FEE  = 50;
    uint constant public CALL_FEE     = 20;
    uint constant public TREASURY_FEE = 20;
    uint constant public BURN_FEE     = 30;
    uint constant public MAX_FEE      = 120;
    ...
    address[] public wbnbToElevenRoute = [wbnb, eleven];
     ...
     */
constructor(address _lpPair, uint _pcsPid, address _vault) public {
        lpPair = _lpPair;
    ...
    function chargeFees() internal {
        ...
        uint toSell = IERC20(cake).balanceOf(address(this)).mul(getBPSFee()).div(10000);
        IERC20(cake).transfer(buybackstrat, toSell);
        address fToken;
        if (lpToken0 == wbnb) fToken = lpToken1;
        else fToken = lpToken0;

        Buybackstrat(buybackstrat).chargeFees(fToken, receiveFee);
    }
