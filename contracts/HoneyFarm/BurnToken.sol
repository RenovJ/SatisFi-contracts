...
// File: contracts/BurnToken.sol

pragma solidity 0.6.12;

contract BurnToken is BEP20 {
    ...
    /**
     * @notice Constructs the BurnToken contract.
     */
    constructor() public BEP20("Burn token", "BURN") {
    ...
    /// @dev overrides transfer function to meet tokenomics of BURN
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (recipient == BURN_ADDRESS ||
            ...
            require(amount == sendAmount + taxAmount, "BURN::transfer: Tax value invalid");
    ...
    function updateTransferTaxRate(uint16 _transferTaxRate) public onlyOperator {
        require(_transferTaxRate <= MAXIMUM_TRANSFER_TAX_RATE, "BURN::updateTransferTaxRate: Transfer tax rate must not exceed the maximum rate.");
    ...
    function transferOperator(address newOperator) public onlyOperator {
        require(newOperator != address(0), "BURN::transferOperator: new operator is the zero address");
        emit OperatorTransferred(_operator, newOperator);
        _operator = newOperator;
    }
    
    function setWhitelist(uint _number, address _address) public onlyOperator {
        require(_number <= 5 && _number >= 1, "BURN::setWhitelist: _number must be 1~5");
        if (_number == 1)
